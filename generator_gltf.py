...
class TLA_OT_operator(Operator):
    ...
    def execute(self, context):
        ...
        def scale(ob):
            bpy.ops.object.select_all(action='DESELECT')
            ob.select_set(True)
            bpy.ops.transform.resize(value=(0.778056, 0.778056, 0.778056), orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
            bpy.ops.object.select_all(action='DESELECT')
